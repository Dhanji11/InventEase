        ...
        >
          ...
          >
            ...
            <div class="content-action btn-toolbar mb-2 mb-md-0">
              <a href="" id="id" onclick="change();" type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addCustomer">
                <i class="ic-plus"></i>
                Add Customer
              </a>
              <script type="text/javascript">
				function change()
				{
				    document.getElementById("id").href = "${pageContext.request.contextPath}/add-customers";
				}
				</script>
            </div>
          </div>
          ...
          <div class="search-area mt-4 mt-md-5 mb-4">
            <form action="" method="" class="">
              ...
              <table class="table table-striped table-sm">
			    ...
			    <tr>
			      <th scope="row">${c.getCustomerCode()}</th>
			      ...
			      <td class="table__actions text-center">
                      <a
                        href="update-customers/${c.getCustomerCode()}"
                      ...
                      >
                      <a
                        href="delete-customers/${c.getCustomerCode()}"
                        class="table__actions-btn"
                        data-toggle="modal"
