        ...
        >
          ...
          >
            ...
            <div class="content-action btn-toolbar mb-2 mb-md-0">
              <a
                href="${pageContext.request.contextPath}/add-purchases"
          ...
          <div class="content-box">
            <div class="table-responsive">
              ...
              <table class="table table-striped table-sm">
			    ...
			    <tr>
			      <th scope="row">${p.getPurchaseId()}</th>
			      <td>${p.getProduct().getProductCode()}</td>
			      <td>${p.getProduct().getProductName()}</td>
			      <td>${p.getPurchaseQuantity()}</td>
			      <td>&#8377;${p.getPurchaseQuantity() * p.getProduct().getProductcp() }</td>
			      <td>${p.getSupplier().getSupplierCode()}</td>
			      <td>${p.getDate()}</td>
			      
			      <td class="table__actions text-center">
                      <a
                        href="update-purchase/${p.getPurchaseId()}"
                      ...
                      >
                      <a
                        href="delete-purchase/${p.getPurchaseId()}"
                        class="table__actions-btn"
                        data-toggle="modal"
