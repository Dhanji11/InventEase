...
<body>
	...
	<form action="create-user">
		...
		<div class="container signin">
			<p>
				Already have an account? <a href="" id="myLink">Sign in</a>.
			</p>
			<script>
	        ...
	        this.href='${pageContext.request.contextPath}/login-user?email='+ encodeURIComponent(email)+'&password='+encodeURIComponent(password);
						});
			</script>
