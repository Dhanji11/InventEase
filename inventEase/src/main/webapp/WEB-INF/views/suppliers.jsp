  ...
  <body>
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 pr-3">
      <a class="navbar-brand col-1 col-md-2 mr-0" href="/">
        ...
        <span class="navbar-brand_name_lower">Management System</span>
      </a>
      <button
        ...
        >
          ...
          >
            ...
            <div class="content-action btn-toolbar mb-2 mb-md-0">
              <a href="" id="id" onclick="change();" type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addSupplier">
                <i class="ic-plus"></i>
                Add Supplier
              </a>
              <script type="text/javascript">
				function change()
				{
				    document.getElementById("id").href = "${pageContext.request.contextPath}/add-suppliers";
				}
				</script>
            </div>
          </div>
          ...
          <div class="search-area mt-4 mt-md-5 mb-4">
            <form action="" method="" class="">
              <div class="container">
                ...
                >
                  ...
                  <div class="col-lg-2 d-flex">
                    <a onclick="changeLink();" id="anchor" class="btn btn-primary mr-2">
                      <i class="ic-magnifying-glass"></i>
                      Search
                    </a>
                    <script type="text/javascript">
					function changeLink()
					{
					    ...
					    document.getElementById("anchor").href = "${pageContext.request.contextPath}/search-suppliers/"+text ;
					}
					</script>
                  </div>
                </div>
             ...
             <table class="table table-striped table-sm">
			    ...
			    <tr>
			      <th scope="row">${s.getSupplierCode()}</th>
			      <td>${s.getSupplierName()}</td>
			      <td>${s.getSupplierAddress()}</td>
			      <td>${s.getSupplierContact() }</td>
 
			      <td class="table__actions text-center">
                      <a
                        href="update-suppliers/${s.getSupplierCode()}"
                      ...
                      >
                      <a
                        href="delete-suppliers/${s.getSupplierCode()}"
                        class="table__actions-btn"
                        data-toggle="modal"
